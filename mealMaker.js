...
menu.addDishToCourse('appetizers', 'sausage', 7.00);
menu.addDishToCourse('appetizers', 'drink', 6.00);

menu.addDishToCourse('mains', 'fufu', 10);
menu.addDishToCourse('mains', 'banku', 15);
menu.addDishToCourse('mains', 'rice', 20);

menu.addDishToCourse('desserts', 'ice cream', 4.0);
menu.addDishToCourse('desserts', 'cold cream', 4.9);
menu.addDishToCourse('desserts', ' cream', 4.1);
